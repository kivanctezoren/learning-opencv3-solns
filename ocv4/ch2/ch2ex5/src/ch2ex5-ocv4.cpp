...
int main(int argc, char **argv) {
    ...
    cv::namedWindow("ch2ex5-ocv4", cv::WINDOW_NORMAL);
    
    int downsmp_lvl = DWNSMP_MIN;  // Between 2 and 8, for pyramid downsampling
    cv::createTrackbar("DownsampleLevel", "ch2ex5-ocv4", &downsmp_lvl, 8,
        trackbar_slide, &downsmp_lvl);
    cv::setTrackbarMin("DownsampleLevel", "ch2ex5-ocv4", downsmp_lvl);
    cv::setTrackbarPos("DownsampleLevel", "ch2ex5-ocv4", downsmp_lvl);
